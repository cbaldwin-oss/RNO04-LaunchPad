...
async addOption() {
        ...
        try {
            ...
            const { error } = await _supabase.from('RNO04dropdownoptions').insert([payload]);
            ...
            if (typeof fetchRNO04dropdownoptions === 'function') {
                await fetchRNO04dropdownoptions(); 
            }
    ...
    async deleteOption(val) {
        ...
        try {
            ...
            const { error } = await _supabase
                .from('RNO04dropdownoptions') // Updated table name
                .update(update)
            ...
            if (typeof fetchRNO04dropdownoptions === 'function') {
                await fetchRNO04dropdownoptions(); // Updated function name
            }
